				...
				<div className='absolute z-0 inset-0 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#086_100%)] dark:[background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#086_100%)]'>
					<section className='z-auto'>
						<div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12'>
							<a
								href='https://github.com/devdeck101/authjs-prisma-template'
								className='inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700'
								target='_blank'
								rel='noreferrer'>
								<span className='text-xs bg-primary-600 rounded-full text-foreground dark:text-white px-4 py-1.5 mr-3'>News</span> <span className='text-sm font-medium'>Auth Starter-Kit</span>
								<svg
							...
							<h1 className='mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white'>
								<span className='bg-gradient-to-r from-primary dark:to-white to-gray-600 text-transparent bg-clip-text'>Ready to authenticate your new project</span>
							</h1>
							<p className='mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400'>This Starter-Kit was developed to save your time. Here you will find what you need to start developing your project securely.</p>
							<div className='flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4'>
								<a
									href='https://www.youtube.com/playlist?list=PLR8OzKI52ppUa7VP0D671haaiQAkIww3W'
							...
							<div className='px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36'>
								<span className='font-semibold text-gray-400 uppercase'>Channel Support</span>
